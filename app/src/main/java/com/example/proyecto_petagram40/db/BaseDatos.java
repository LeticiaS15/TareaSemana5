...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryCrearTablaContacto = "CREATE TABLE "    + ConstantesBD.TABLE_MASCOTA +"("
        ...
        String queryCrearTablaPERRITO = "CREATE TABLE "    + ConstantesBD.TABLE_PERRITO + "("
                + ConstantesBD.TABLE_PERRITO_ID               + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + ConstantesBD.TABLE_PERRITO_UPDATE           + " INTEGER " + ")";
    ...
    public void agregarPerrito(){
        SQLiteDatabase db = getWritableDatabase();
        String query = "INSERT INTO " + ConstantesBD.TABLE_PERRITO
                + "(" + ConstantesBD.TABLE_PERRITO_UPDATE + ")"
                + " VALUES (" + 1 + ")";
        db.execSQL(query);
        db.close();
    }
    ...
    public boolean ActualizarMascota(){
        SQLiteDatabase db = getWritableDatabase();
        String query = "SELECT COUNT (*) FROM " + ConstantesBD.TABLE_PERRITO;
    ...
    public ArrayList<Mascota> obtenerMascotasFavoritas(){
        ...
        SQLiteDatabase db = getWritableDatabase();
        String query = "SELECT * FROM " + ConstantesBD.TABLE_LIKES + " L JOIN " + ConstantesBD.TABLE_MASCOTA
                + " P ON L." + ConstantesBD.TABLE_LIKES_ID_PETS_FK + " = P." + ConstantesBD.TABLE_MASCOTA_ID;
        Cursor registros = db.rawQuery(query, null);
